...
public class Fragment10 extends FragmentTabBase {
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return LayoutInflater.from(getActivity()).inflate(R.layout.fragment10, container, false);
    }
    ...
    public void onStart() {
        ...
        listView = getActivity().findViewById(R.id.listView10);
